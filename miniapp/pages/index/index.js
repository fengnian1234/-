...
// FAQ 数据
const FAQS = [
  { q: '民宿在庐山什么位置？', a: '三家民宿分别位于庐山不同位置：归墅在山上大林沟路27号（近索道站），山纪在山上慧远路104号（近索道出口），东林外在庐山山下赛阳镇（近东林寺）。查看对应民宿页面了解详细地址。' },
  { q: '入住和退房时间是几点？', a: '入住时间：14:00之后\n退房时间：12:00之前\n如需提前入住或延迟退房，请提前联系前台协商。' },
  { q: '如何预订房间？', a: '您可以通过携程、美团、飞猪、大众点评等平台搜索对应民宿名称预订。预订成功后建议联系前台，解锁AI管家服务。' },
  { q: '停车方便吗？', a: '归墅和山纪位于山上，有免费停车场。7-8月暑期禁止外地车辆自驾上山，需换乘索道或景区大巴。东林外位于山下，停车方便。' },
  { q: '可以带宠物吗？', a: '归墅和东林外支持免费携宠入住（需提前联系确认）。山纪暂不支持携宠，感谢理解。' },
  { q: 'AI管家是什么？', a: '预订成功后联系前台确认，即可解锁AI管家，享受24小时智能旅行顾问服务。' },
  { q: '积分有什么用？', a: '签到、评价、分享民宿都可以获得积分。积分可兑换精品咖啡、房型升级、延迟退房，以及庐山云雾茶包/礼盒等特色礼品。金卡以上积分加速×1.2~1.4，三家民宿积分通用。' },
